...
private:
	...
	bool srvPause_callback(std_srvs::SetBool::Request& req,
			std_srvs::SetBool::Response& res);
	bool srvNodeCtrl_callback(rona_msgs::NodeCtrlSRVRequest& req,
			rona_msgs::NodeCtrlSRVResponse& res);
	bool srvReverseOn_callback(std_srvs::EmptyRequest& req,
			std_srvs::EmptyResponse& res);
	bool srvReverseOff_callback(std_srvs::EmptyRequest& req,
			std_srvs::EmptyResponse& res);
	bool srvReverseSw_callback(std_srvs::EmptyRequest& req,
			std_srvs::EmptyResponse& res);
...
private:
	...
	//dataelements
	void callbackDynamicReconfigure(rona_move::MoveConfig& config,
			uint32_t level);
	ros::NodeHandle _nh;
	...
	//todo add pos hold
	enum State {
		STOP = 0, MOVE = 1, PAUSE = 2, HOLD_POS = 3
	};
